...
#if QT_CONFIG(whatsthis)
        self.pb_paste_metadata.setWhatsThis(QCoreApplication.translate("Form", u"<html><head/><body><p>Paste selected metadata to highlighted image entries</p></body></html>", None))
#endif // QT_CONFIG(whatsthis)
...
#if QT_CONFIG(whatsthis)
        self.pb_copy_metadata.setWhatsThis(QCoreApplication.translate("Form", u"<html><head/><body><p><span style=\" font-weight:600;\">Copy metadata</span></p><p><br/></p><p>Select and copy metadata from current image</p><p><br/></p></body></html>", None))
#endif // QT_CONFIG(whatsthis)
